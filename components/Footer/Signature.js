...
const style = {
    ...
    list: 'block my-4 py-2 px-2 md:px-4 font-sm md:text-md text-gray-100 font-bold hover:text-stone-200 hover:text-stone-400  transition duration-[300ms] hover:mx-2 transition-all duration-[300ms]',
